...
; Set to false to start in window mode
ShowFullScreen=true

; Sets the default position and size of the window in window mode.
; Use 'auto' for 2/3 of screen size or 'max' to start with maximized window
...
; Can be LastModDate, CreationDate or FileName
...
; Contrast Gamma Sharpen ColorCorrection ContrastCorrection LightenShadows DarkenHighlights DeepShadows CyanRed MagentaGreen YellowBlue 
LandscapeModeParams=-1 -1 -1 -1 0.5 1.0 0.75 0.4 -1 -1 -1
...
;           %filetitle%  : Filename excluding path
;           %directory%  : Directory, without trailing backslash
