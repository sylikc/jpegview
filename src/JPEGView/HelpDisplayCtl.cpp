...
void CHelpDisplayCtl::GenerateHelpDisplay() {
	...
	m_pHelpDisplay->AddLine(_KeyDesc(IDM_HIDE_TITLE_BAR), CNLS::GetString(_T("Hide window title bar mode")));
	m_pHelpDisplay->AddLine(_KeyDesc(IDM_ALWAYS_ON_TOP), CNLS::GetString(_T("Set window mode always on top")));
